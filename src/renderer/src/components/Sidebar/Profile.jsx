...
export function Profile() {
  ...
  if (!isAuthenticated) {
    return (
      <button className="text-rotion-100 flex mx-5 items-center gap-1 text-sm font-medium group">
  ...
  return (
    <button className="text-rotion-50 flex mx-5 items-center gap-1 text-sm font-medium group">
      <img
